...
const Footer = () => {
  return (
    <footer className="bg-[#212121] text-white pt-16">
      <div className="w-full px-[20px] md:px-[30px] lg:px-[30px] xl:max-w-7xl xl:mx-auto pb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col items-center sm:items-start space-y-3">
            ...
            <div className="flex items-center space-x-2 text-sm sm:text-base">
              <svg className="w-4 h-4 text-[#97f03d]" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex space-x-3 pt-3">
              ...
              <a href="#" className="w-8 h-8 bg-[#97f03d] rounded-lg flex items-center justify-center text-black hover:bg-[#7cc32f]">
                <FaFacebookF size={15} />
              </a>
