...
const ProductCard = ({ product }) => {
  return (
    <div className="relative bg-white p-4 text-center border-2 border-gray-100 rounded-lg flex flex-col justify-between group overflow-hidden transition-all duration-200 hover:shadow-lg">

      {/* Image */}
      <div className="relative w-full h-56 sm:h-60 md:h-64 mb-4">
        <Image
          src={product.image}
          alt={product.name}
          fill
      ...
      {/* Card Text */}
      <h3 className="text-gray-800 text-lg font-semibold mb-1 line-clamp-2">
        {product.name}
      </h3>
